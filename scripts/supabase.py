...
EXPECTED_SEED_HEAD = "3604e8a54dcdd17e577751561dc6b5a750db4d8dfe92b1b13481dd507ac5dc37"
#: Audit rows laid down by the seed: one per trial, and there are nine — eight
#: generated trials plus the fixed AYU-008 demo trial (see app/case_data.py).
SEED_EVENT_COUNT = 9
