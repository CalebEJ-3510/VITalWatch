...
RECRUITMENT_FACTORS = [
    ...
    ("Enrolment velocity", "Participants per site per month below the rate the plan assumes."),
]

#: (participant number within the trial, narrative as a site would write it, day on trial,
